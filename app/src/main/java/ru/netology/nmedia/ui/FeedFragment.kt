...
class FeedFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.navigateToEditContentScreenEvent.observe(this) { initialContent ->
            val direction =
                FeedFragmentDirections.fromFeedFragmentToPostContentFragment(initialContent)
            findNavController().navigate(direction)
        }

        viewModel.navigateToViewContentScreenEvent.observe(this) { postId ->
            val direction = FeedFragmentDirections.fromFeedFragmentToPostViewFragment(postId)
            findNavController().navigate(direction)
        }
